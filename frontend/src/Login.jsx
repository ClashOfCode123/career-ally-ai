    ...
    >
      <div className="w-full max-w-md bg-[#0a0a0a]/80 border border-white/5 rounded-3xl p-8 backdrop-blur-2xl shadow-2xl relative overflow-hidden">
        ...
        <div className="text-center mb-8">
          <h2 className="text-2xl font-black tracking-tight text-white mb-2">Access Automata</h2>
          <p className="text-gray-400 text-sm font-mono tracking-widest uppercase">Initialize Session</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          >
            {isLoading ? (
              ...
              <>
                <LogIn size={18} />
                <span className="font-mono text-sm uppercase tracking-widest">Execute Login</span>
              </>
            )}
          </motion.button>
        </form>
        ...
        <div className="mt-8 text-center">
          <button
            ...
            className="text-gray-400 hover:text-emerald-400 text-sm transition-colors flex items-center justify-center w-full space-x-1"
          >
